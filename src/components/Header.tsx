        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 bg-sky-500/15 hover:bg-sky-500/25 text-sky-300 font-bold rounded-xl transition-all border border-sky-500/30 text-xs shadow-sm cursor-pointer"
              title="تثبيت تطبيق Telegram APK المباشر على الهاتف"
            >
              <Download className="w-4 h-4 text-sky-400" />
              <span className="hidden sm:inline">تثبيت التطبيق</span>
              <span className="text-[10px] font-mono px-1.5 py-0.2 rounded bg-sky-500/25 text-sky-200 border border-sky-400/40 font-black">
                APK
              </span>
            </button>
            <button
